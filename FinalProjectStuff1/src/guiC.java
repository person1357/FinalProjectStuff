...
public class guiC extends JFrame{
    ...
    public guiC()
    {
        ...
        ImageIcon u1 = new ImageIcon(clder.getResource("unit1 (1).jpg"));
		...
		public void actionPerformed(ActionEvent event) {
			...
			ActionListener taskPreformer= new ActionListener()
			{
					public void actionPerformed(ActionEvent evt) 
					{
						...
						{
							timer.stop();
							JOptionPane.showMessageDialog(container, "You Lose");
						}
				...
				{	
					timer = new javax.swing.Timer(1000, taskPreformer); // construction a Swing timer that goes off every 1000 msec (1 sec)
